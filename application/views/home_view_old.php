      ...
      <div class="col-md-12 col-lg-12">
        <div class="row">
            ...
            ?>
                  ...
                  <?php } ?>
                      <div class="col-6 col-sm-6 col-md-6 col-lg-3 my-3">
                  <div class="each-choirs" style="border: 1px solid #ecc3c3"> <img src="<?php echo $event_image; ?>" class="img-fluid mx-auto d-table" alt=""> <a href="<?php echo base_url();?>event/details/<?php echo $event['event_id']; ?>" class="link-listing"><i class="fas fa-eye"></i></a>
                    <div class="choirs-describe" style="padding: 0">
                    <div class="row" style="background-color: #a20000; opacity: 0.9; color: #fff; padding-left: 6px">
                      <div class="col-sm-3" style="vertical-align: middle; border-right: 1px solid #fff; font-weight: 700">
                        <span><?php echo 'Aug'; ?></span><br>
                        <span><?php echo '17'; ?></span>
                      </div>
                      <div class="col-sm-8" style="vertical-align: middle">
                        <h4 class="event-name"><?php echo $event_name; ?></h4>
                        <p style="padding: 0; margin: 0">Friday 8:00 AM</p>
                        <p style="padding: 0; margin: 0"><?php echo $host; ?></p>
                        <!-- <p style="padding: 0; margin: 0">100 Interested</p> -->
                      </div>
                    </div>
                      <!-- <p class="close-notice"><?php echo $event_time; ?></p> -->
                      <!-- <h4 class="event-name"><?php echo $event_name; ?></h4> -->
                      <!-- <ul class="event-address">

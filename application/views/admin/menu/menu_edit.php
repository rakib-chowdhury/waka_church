      ...
      <div class="box">
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open_multipart(base_url('admin/menu/edit/'.$menu['menu_id']), 'class="form-horizontal"');?>  
            ...
            <div class="form-group">   
              ...
              <div class="col-sm-9">
                ...
                <input style="width: 70%; display: inline-block;" type="text" name="menu_link" class="form-control" id="menu_link" placeholder="Menu Link" value="<?php if(isset($menu['menu_link'])){ 
                       $replace_base_path = str_replace(base_url('/'),'',$menu['menu_link']);
                       echo $replace_base_path;
                    }else{ echo ''; };?>">
              </div>   
            </div>
            <div class="form-group">   

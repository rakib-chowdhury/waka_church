    ...
    <div class="col-md-12">
      <div class="box">
        ...
        <div class="box-body my-form-body">
          ...
          <?php echo form_open_multipart(base_url('admin/faq/edit/'.$details['faq_id']), 'class="form-horizontal"');?>  
              <input type="hidden" name="category_id" value="<?php echo $details['faq_id'];?>">

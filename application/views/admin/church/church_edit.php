    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Edit Church</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open_multipart(base_url('admin/church/edit/'.$details['listings_id']), 'class="form-horizontal"');?>  
            ...
            <div class="form-group"> 
              ...
              <div class="col-sm-9">
                <div class="checkbox">
                  <label><input type="checkbox" name="church_parking" value="1" <?php if(isset($details['church_parking']) && $details['church_parking'] == 1){ echo "checked"; }else{ echo ''; };?>>Church Parking</label>
                </div>
                <div class="checkbox">
                  <label><input type="checkbox" name="church_wifi" value="1" <?php if(isset($details['church_wifi']) && $details['church_wifi'] == 1){ echo "checked"; }else{ echo ''; };?>>Church Wifi</label>
                </div>
                <div class="checkbox">
                  <label><input type="checkbox" name="church_wheelchair" value="1" <?php if(isset($details['church_wheelchair']) && $details['church_wheelchair'] == 1){ echo "checked"; }else{ echo ''; };?>>Church WheelChair</label>
                </div>
                <div class="checkbox">
                  <label><input type="checkbox" name="church_family_friendly" value="1" <?php if(isset($details['church_family_friendly']) && $details['church_family_friendly'] == 1){ echo "checked"; }else{ echo ''; };?>>Church family Friendly</label>
                </div>
                <div class="checkbox">
                  <label><input type="checkbox" name="church_online_transfer" value="1" <?php if(isset($details['church_online_transfer']) && $details['church_online_transfer'] == 1){ echo "checked"; }else{ echo ''; };?>>Church Online Transfer</label>
                </div>
                <div class="checkbox">
                  <label><input type="checkbox" name="church_air_conditioned" value="1" <?php if(isset($details['church_air_conditioned']) && $details['church_air_conditioned'] == 1){ echo "checked"; }else{ echo ''; };?>>Church Air Conditioned</label>
                </div>
                <div class="checkbox">
                  <label><input type="checkbox" name="church_kids_dept" value="1" <?php if(isset($details['church_kids_dept']) && $details['church_kids_dept'] == 1){ echo "checked"; }else{ echo ''; };?>>Church Kids dept</label>
                </div>
                <div class="checkbox">
                  <label><input type="checkbox" name="church_rest_room" value="1" <?php if(isset($details['church_rest_room']) && $details['church_rest_room'] == 1){ echo "checked"; }else{ echo ''; };?>>Church Rest Room</label>
                </div>                                                 
              </div>   
            </div>

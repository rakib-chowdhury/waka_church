    ...
    <div class="col-md-12">
      <div class="panel panel-info">
                ...
                <div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-details-information">
                    <tbody>
                      ...
                      <tr>
                        <td class="cust_head"><strong>Church Parking</strong></td>
                        <td><?php if($details['church_parking'] == 1){ echo "Yes"; }else{ echo "No"; }?></td>
                      </tr>
                      <tr>
                        <td class="cust_head"><strong>Church Wifi</strong></td>
                        <td><?php if($details['church_wifi'] == 1){ echo "Yes"; }else{ echo "No"; }?></td>
                      </tr>
                      <tr>
                        <td class="cust_head"><strong>Church Wheelchair</strong></td>
                        <td><?php if($details['church_wheelchair'] == 1){ echo "Yes"; }else{ echo "No"; }?></td>
                      </tr>
                      <tr>
                        <td class="cust_head"><strong>Church Fanily Friendly</strong></td>
                        <td><?php if($details['church_family_friendly'] == 1){ echo "Yes"; }else{ echo "No"; }?></td>
                      </tr>
                      <tr>
                        <td class="cust_head"><strong>Church Online Tranfer</strong></td>
                        <td><?php if($details['church_online_transfer'] == 1){ echo "Yes"; }else{ echo "No"; }?></td>
                      </tr>
                      <tr>
                        <td class="cust_head"><strong>Church air Conditioned</strong></td>
                        <td><?php if($details['church_air_conditioned'] == 1){ echo "Yes"; }else{ echo "No"; }?></td>
                      </tr> 
                      <tr>
                        <td class="cust_head"><strong>Church Kids Dept</strong></td>
                        <td><?php if($details['church_kids_dept'] == 1){ echo "Yes"; }else{ echo "No"; }?></td>
                      </tr>                                                                                                                                           
                      <tr>
                        <td class="cust_head"><strong>Church Rest Room</strong></td>
                        <td><?php if($details['church_rest_room'] == 1){ echo "Yes"; }else{ echo "No"; }?></td>
                      </tr> 
                      <tr>
            ...
            <div class="panel-footer back_bt">
                <a href="<?php echo base_url('admin/church'); ?>" class="btn btn-warning back_bt"><?php if($this->lang->line('back_btn')){echo $this->lang->line('back_btn');}else{ echo "Back";} ?></a>
            </div>
      </div>
    </div>
  </div>  

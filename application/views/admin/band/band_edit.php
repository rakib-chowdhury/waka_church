    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Edit Band</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open_multipart(base_url('admin/band/edit/'.$details['listings_id']), 'class="form-horizontal"');?>  
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <div class="col-md-11">
                  ...
                  <a href="<?php echo base_url('admin/band'); ?>" class="btn btn-warning back_bt">Back</a>
                </div>
              </div>
            <?php echo form_close(); ?>
          </div>

      ...
      <div class="box">
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php endif; ?>
            <?php echo form_open_multipart(base_url('admin/event_reviews/edit/'.$details['event_review_id'].'/'.$details['event_id'].'/'.$this->uri->segment(6)), 'class="form-horizontal"' )?>                    
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <div class="col-md-11">
                  ...
                  <a href="<?php echo base_url('admin/event_reviews/index/'.$details['event_id'].'/'.$this->uri->segment(6)); ?>" class="btn btn-warning back_bt">Back</a>
                </div>
              </div>
            <?php echo form_close(); ?>            
          </div>
...
<script>
    <?php if($this->uri->segment(6) == "event"){ ?>

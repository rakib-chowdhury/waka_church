...
<head>
<meta charset="utf-8">
<title>Registered Provider | Zoom Care Spa</title>
</head>
...
<table bgcolor="#fcfcfc" class="emailer" cellpadding="8" cellspacing="0" width="600" style="border:1px solid #ccc; margin:0 auto; padding:0px;">
	<thead>
        ...
        <tr>
        	<th colspan="2">
            	<h2 style="padding:0px; margin:0px;">Provider Info</h2>
            </th>
        </tr>
        <tr>
        	<th colspan="2">
            	<h4 style="padding:0px; margin:0px;">Provider Details</h4>
            </th>
        </tr>
    </thead>
    <tbody>
    	<tr bgcolor="#ffeaff">
        	<td width="50%" align="right">Provider Name :</td>

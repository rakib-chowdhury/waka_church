                    ...
                    <div class="col-lg-12">
                      <ul class="nav nav-pills mb-3 reg-area mx-auto d-flex" id="pills-tab" role="tablist">
                       <!-- <li class="nav-item">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Join Wakachurch now. It's free!</a><br>
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="e.g Jack Reacher">
                                  </div>
                                </div>
                                <div class="col-lg-6">
                                  <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                 ...
                                 <div class="col-lg-12">
                                  <!-- <div class="form-group"> -->
                                    ...
                                    <label style="font-weight: 400">My Church/choir/band not listed? </label> <input type="checkbox" name="agree" id="test2" value="1" name="bandnotlisted" /> <label for="test2" style="display: inline; margin-left: 6px"></label>
                                  <!-- </div> -->
                                </div>
                                <div class="col-lg-12">
                                  <!-- <div class="form-group"> -->
                                  ...
                                  <!-- </div> -->
                                   <label style="font-weight: 400">I agree to the <a href="<?php echo base_url('cms/index/terms-conditions'); ?>">terms and conditions </a></label> <input type="checkbox" name="agree" id="test1" /> <label for="test1" style="display: inline; margin-left: 6px"></label>
                                </div>
